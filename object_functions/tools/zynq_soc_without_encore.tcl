...
proc create_hier_cell_hier_rvcore_peripheral { parentCell nameHier } {
  ...
  create_bd_pin -dir I -type clk uncore_clk
...
proc create_hier_cell_hier_clkrst { parentCell nameHier } {
  ...
  create_bd_pin -dir O -type clk uncore_clk
  ...
  set_property -dict [ list \
   ...
   CONFIG.CLK_OUT2_PORT {uncore_clk} \
  ...
  # Create port connections
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins uncore_clk] [get_bd_pins clk_wiz_0/uncore_clk] [get_bd_pins uncorerst/slowest_sync_clk]
  connect_bd_net -net clk_wiz_0_core_clk [get_bd_pins core_clk] [get_bd_pins clk_wiz_0/core_clk]
...
proc create_hier_cell_hier_arm_peripheral { parentCell nameHier } {
  ...
  create_bd_intf_pin -mode Slave -vlnv xilinx.com:interface:aximm_rtl:1.0 S04_AXI_0
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net Conn1 [get_bd_intf_pins S04_AXI_0] [get_bd_intf_pins axi_interconnect_0/S04_AXI]
  ...
  connect_bd_net -net axi_uartlite_0_tx [get_bd_pins tx] [get_bd_pins axi_uartlite_0/tx]
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins uncore_clk] [get_bd_pins axi_dma_arm/m_axi_mm2s_aclk] [get_bd_pins axi_dma_arm/m_axi_s2mm_aclk] [get_bd_pins axi_dma_arm/m_axi_sg_aclk] [get_bd_pins axi_dma_arm/s_axi_lite_aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_interconnect_0/S01_ACLK] [get_bd_pins axi_interconnect_0/S02_ACLK] [get_bd_pins axi_interconnect_0/S03_ACLK] [get_bd_pins axi_interconnect_0/S04_ACLK] [get_bd_pins axi_interconnect_1/ACLK] [get_bd_pins axi_interconnect_1/M00_ACLK] [get_bd_pins axi_interconnect_1/M01_ACLK] [get_bd_pins axi_interconnect_1/M02_ACLK] [get_bd_pins axi_interconnect_1/S00_ACLK] [get_bd_pins axi_uartlite_0/s_axi_aclk] [get_bd_pins corerst/s_axi_aclk]
  ...
  connect_bd_net -net rvcore_uncorerst_interconnect_aresetn [get_bd_pins S00_ARESETN] [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_interconnect_0/S01_ARESETN] [get_bd_pins axi_interconnect_0/S02_ARESETN] [get_bd_pins axi_interconnect_0/S03_ARESETN] [get_bd_pins axi_interconnect_0/S04_ARESETN] [get_bd_pins axi_interconnect_1/ARESETN] [get_bd_pins axi_interconnect_1/M00_ARESETN] [get_bd_pins axi_interconnect_1/M01_ARESETN] [get_bd_pins axi_interconnect_1/M02_ARESETN] [get_bd_pins axi_interconnect_1/S00_ARESETN]
  connect_bd_net -net rx_1 [get_bd_pins rx] [get_bd_pins axi_uartlite_0/rx]
...
proc create_root_design { parentCell } {
  ...
  set AXI_Corpus [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:aximm_rtl:1.0 AXI_Corpus ]
  set_property -dict [ list \
  ...
  set AXI_DUT [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:aximm_rtl:1.0 AXI_DUT ]
  set_property -dict [ list \
   CONFIG.ADDR_WIDTH {40} \
   CONFIG.ARUSER_WIDTH {1} \
   CONFIG.AWUSER_WIDTH {1} \
  ...
  set uncore_clk [ create_bd_port -dir O -type clk uncore_clk ]
  set_property -dict [ list \
   CONFIG.ASSOCIATED_BUSIF {AXI_MEM:AXI_MMIO:AXI_DMA:AXI_Corpus:AXI_DUT} \
 ] $uncore_clk
  ...
  connect_bd_intf_net -intf_net S04_AXI_0_1 [get_bd_intf_ports AXI_DUT] [get_bd_intf_pins hier_arm_peripheral/S04_AXI_0]
  ...
  connect_bd_intf_net -intf_net S_AXI_HP1_FPD_0_1 [get_bd_intf_ports AXI_Corpus] [get_bd_intf_pins zynq_ultra_ps_e_0/S_AXI_HP1_FPD]
  connect_bd_intf_net -intf_net S_AXI_MEM_1 [get_bd_intf_ports AXI_MEM] [get_bd_intf_pins hier_arm_peripheral/S_AXI_MEM]
connect_bd_intf_net -intf_net [get_bd_intf_nets S_AXI_MEM_1] [get_bd_intf_ports AXI_MEM] [get_bd_intf_pins system_ila_0/SLOT_0_AXI]
  ...
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_ports uncore_clk] [get_bd_pins hier_arm_peripheral/uncore_clk] [get_bd_pins hier_clkrst/uncore_clk] [get_bd_pins hier_rvcore_peripheral/uncore_clk] [get_bd_pins system_ila_0/clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_lpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihp0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihp1_fpd_aclk]
  connect_bd_net -net hier_arm_peripheral_interrupt [get_bd_pins hier_arm_peripheral/interrupt] [get_bd_pins xlconcat_1/In2]
  connect_bd_net -net hier_clkrst_core_clk [get_bd_ports core_clk] [get_bd_pins hier_clkrst/core_clk]
  ...
  connect_bd_net -net proc_sys_reset_1_peripheral_aresetn [get_bd_ports uncorerstn] [get_bd_pins hier_arm_peripheral/uncorerstn] [get_bd_pins hier_clkrst/uncorerstn] [get_bd_pins hier_rvcore_peripheral/uncorerstn] [get_bd_pins system_ila_0/resetn]
  ...
  assign_bd_address -offset 0x000800000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces AXI_DUT] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_LOW] -force
  ...
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces AXI_Corpus] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_DDR_LOW] -force
