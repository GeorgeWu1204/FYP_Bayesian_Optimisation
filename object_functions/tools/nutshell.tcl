...
proc create_root_design { parentCell } {
  ...
  set uncore_clk [ create_bd_port -dir I -type clk uncore_clk ]
  set_property -dict [ list \
  ...
  connect_bd_net -net core_clk_1 [get_bd_ports core_clk] [get_bd_pins NutShell_0/clock] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_1/S00_ACLK] [get_bd_pins axi_interconnect_2/ACLK] [get_bd_pins axi_interconnect_2/S00_ACLK] [get_bd_pins system_ila_0/clk]
  connect_bd_net -net intrs_1 [get_bd_ports intrs] [get_bd_pins NutShell_0/io_meip]
  connect_bd_net -net uncore_clk_1 [get_bd_ports uncore_clk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_interconnect_1/ACLK] [get_bd_pins axi_interconnect_1/M00_ACLK] [get_bd_pins axi_interconnect_2/M00_ACLK] [get_bd_pins axi_protocol_convert_0/aclk] [get_bd_pins axi_protocol_convert_1/aclk]
